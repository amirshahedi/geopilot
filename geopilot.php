<?php
/**
 * Plugin Name:       GeoPilot
 * Plugin URI:         https://geopilot.ca
...
function wgt_init() {
	...
	require_once WGT_PLUGIN_DIR . 'includes/class-wgt-ai-content-negotiation.php';
	require_once WGT_PLUGIN_DIR . 'includes/class-wgt-extractability-scorer.php';
	...
	WGT_Admin::init();
	WGT_AI_Content_Negotiation::init();
	WGT_Extractability_Scorer::init();
}
